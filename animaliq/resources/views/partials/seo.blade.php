...
@endphp
<meta name="description" content="{{ $description ? Str::limit(strip_tags($description), 160) : 'Animal IQ – Education, conservation, and community at the heart of wildlife protection. Programs, events, research, and ways to get involved.' }}">
