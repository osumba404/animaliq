...
<div class="theme-card rounded-lg p-8">
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative">
                <input type="password" name="password" id="password" required autocomplete="new-password" class="theme-input pr-10" aria-describedby="password-requirements">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePwd('password_confirmation',this)" class="absolute inset-y-0 right-0 flex items-center px-3 theme-text-secondary hover:text-[var(--accent-orange)] transition" tabindex="-1" aria-label="Toggle confirm password visibility">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                </button>
            </div>
        </div>
