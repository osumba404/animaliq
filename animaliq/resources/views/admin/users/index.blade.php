...
<p class="mb-4"><a href="{{ route('admin.users.create') }}" class="theme-btn inline-block">Add User</a></p>
<ul class="space-y-0">
    @foreach($users as $u)
    <li class="flex justify-between items-center py-3 theme-table-cell border-b">
        ...
        <span>
            <a href="{{ route('admin.users.edit', $u) }}" class="theme-link font-medium">Edit</a>
            @if($u->id !== auth()->id())
