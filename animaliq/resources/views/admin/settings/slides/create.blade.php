...
@section('content')
<form action="{{ route('admin.settings.slides.store') }}" method="POST" class="max-w-md" enctype="multipart/form-data">
    @csrf
    ...
    <div class="mb-4"><label class="block font-medium theme-text-secondary mb-1">Image</label><input type="file" name="image" accept="image/*" class="theme-input w-full"></div>
