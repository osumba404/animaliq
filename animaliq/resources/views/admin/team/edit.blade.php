...
@section('content')
<form action="{{ route('admin.team.update', $member) }}" method="POST" class="max-w-md">
    @csrf
    @method('PUT')
    ...
    <div class="mb-4"><label class="block font-medium theme-text-secondary mb-1">Image path</label><input type="text" name="image" value="{{ old('image', $member->image) }}" class="theme-input w-full"></div>
