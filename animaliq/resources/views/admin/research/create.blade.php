...
<div class="mb-4"><label class="block font-medium theme-text-secondary mb-1">Banner image path</label><input type="text" name="banner_image" value="{{ old('banner_image') }}" class="theme-input w-full" placeholder="path/to/banner.jpg"></div>
